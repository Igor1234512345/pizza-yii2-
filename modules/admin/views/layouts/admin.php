                    ...
                    <div class="col-sm-8">
                        <div class="shop-menu pull-right">
                            <ul class="nav navbar-nav">
                                ...
                                <li class="cartstyle"><a href="#" onclick="return getCart()"><i class="fa fa-shopping-cart"></i>
                                ...
                                <?php if(!Yii::$app->user->isGuest) : ?>
                                    <li><a href="<?= \yii\helpers\Url::to(['/site/logout'])?>" data-method="post"><i class="fa fa-user"></i>
